module Gmo
  module Const
    ...
    INPUT_PARAMS = {
      ...
      :account_number_jp     => "AccountNumber_Jpbank",
    ...
    API_ERROR_MESSAGES_JA = {
      ...
      'SB1000002' => '【取消要求、決済中止】お客様がソフトバンクまとめて支払いを中止または取消し処理が失敗しました。',
      'SB1000003' => '【決済中止】お客様がソフトバンクまとめて支払いを中止しました。',
      'SB1000004' => '【決済失敗】ソフトバンクまとめて支払いが失敗しました。',
      'SB1000005' => '【決済要求】後続決済センターとの通信に失敗しました。',
      'SB1000006' => '【利用承諾】お客様がソフトバンクまとめて支払いの処理を中止しました。',
      'SB1000007' => '【利用承諾】お客様がソフトバンクまとめて支払いで処理に失敗しました。',
